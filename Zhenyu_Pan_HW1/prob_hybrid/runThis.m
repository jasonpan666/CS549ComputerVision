...
% image1 = im2single(imread('data/eistein.bmp'));
...
low_frequencies = imfilter(imfilter(image1, filter), filter');
...
high_frequencies = image2 - imfilter(imfilter(image2, filter), filter');
...
figure(4);imagesc(log(abs(fftshift(fft2(image1)))));
figure(5);imagesc(log(abs(fftshift(fft2(image2)))));
figure(6);imagesc(log(abs(fftshift(fft2(low_frequencies)))));
figure(7);imagesc(log(abs(fftshift(fft2(high_frequencies)))));
figure(8);imagesc(log(abs(fftshift(fft2(hybrid_image)))));
